...
public class OrganizationApplication {
	...
	public Docket swaggerApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.sample.microservices.organization.controller"))
	...
	OrganizationRepository repository() {
		...
		repository.add(new Organization("Kafein", "Davutpaşa, İstanbul"));
		repository.add(new Organization("Vodafone", "Maslak, İstanbul"));
		return repository;
	}
