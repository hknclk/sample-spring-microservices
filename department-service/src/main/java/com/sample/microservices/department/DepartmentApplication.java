...
public class DepartmentApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.sample.microservices.department.controller"))
	...
	DepartmentRepository repository() {
		...
		repository.add(new Department(1L, "Yazılım Geliştirme"));
		repository.add(new Department(1L, "Operasyon"));
		repository.add(new Department(2L, "Yazılım Geliştirme"));
		repository.add(new Department(2L, "Operasyon"));
		return repository;
	}
